Rancher supports the Proof Key for Code Exchange (PKCE) extension (RFC 7636) for OIDC authentication providers. Currently, SHA-256 (`S256`) is the only supported PKCE verification method. 
